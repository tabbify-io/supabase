...
export const STORAGE_SIZE_SEGMENTS: readonly StorageSizeSegment[] = [
  { attributeKey: 'live', totalsKey: 'live', name: 'Live objects', color: 'white' },
  {
    attributeKey: 'noncurrent_versions',
    totalsKey: 'noncurrentVersions',
    name: 'Noncurrent versions',
    color: 'yellow',
  },
  {
    attributeKey: 'soft_deleted',
    totalsKey: 'softDeleted',
    name: 'Soft-deleted files',
    color: 'orange',
  },
]
