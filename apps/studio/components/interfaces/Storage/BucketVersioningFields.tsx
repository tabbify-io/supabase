      ...
      <DialogSection className="space-y-3">
        ...
        {isVersioningEnabled && isPublicBucket && (
          <Admonition
            ...
            description={
              <>
                Anyone with a version ID can fetch a noncurrent version of a public object. To hide
                noncurrent versions, add an RLS policy on <code>storage.objects</code> that filters
                on <code>metadata-&gt;&gt;'isCurrent' = 'true'</code>.
              </>
            }
          />
        )}
