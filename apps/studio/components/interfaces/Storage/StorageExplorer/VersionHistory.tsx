  ...
  return (
    <div className="space-y-4">
            ...
            return (
              <li
                ...
                className={cn(
                  ...
                  isComparing ? 'border-brand-500 bg-brand-200' : 'hover:bg-surface-200'
                )}
              >
                {/* A real button, so Enter/Space and screen readers work for free. */}
                <button
                  type="button"
      ...
      <ConfirmationModal
        ...
        confirmLabelLoading="Deleting version..."
        loading={isDeleting}
